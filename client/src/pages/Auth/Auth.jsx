                ...
                <div className="auth-content">
                    <div className="log-in">
                        <div className="inner">
                            ...
                            <h2>Log In</h2>
                            <form action="">
                                <input type="number" name="mobile" placeholder="Mobile Number" className="auth-input-field" />
                                <input type="password" name="password" placeholder="Password" className="auth-input-field" />
                    ...
                    <div className="register">
                        <div className="inner">
                            ...
                            <h2>Register</h2>
                            <form action="">
                                <input type="text" name="fullname" placeholder="Full Name" className="auth-input-field" />
                                <input type="number" name="mobile" placeholder="Mobile Number" className="auth-input-field" />
